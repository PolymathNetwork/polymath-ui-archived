...
class SignInPage extends Component<Props> {
  ...
  render () {
    const ico = (
      <p align='center' style={{ marginBottom: '15px', marginTop: '10px' }}><img src={key} alt='Key' /></p>
    )
    const desc = (
      <span>
      ...
      return (
        <DocumentTitle title='Sign In – Polymath'>
          <div className='pui-single-box'>
            {ico}
            <h2 className='pui-h2' align='center' style={{ lineHeight: '36px' }}>
              Digital Signature Failed.<br />
              Please Sign Using Your Wallet
            </h2>
            <h3 className='pui-h3' align='center'>
              {desc} To proceed with the signing operation, please click on &laquo;SIGN YOUR ACCOUNT&raquo;.
            </h3>
            <br />
            <Remark title='Note'>
    ...
    return (
      <DocumentTitle title='Sign In – Polymath'>
        <div className='pui-single-box'>
          {ico}
          <h2 className='pui-h2' align='center'>Digital Signature with Your Wallet</h2>
          <h3 className='pui-h3' align='center'>
          ...
          <br />
          <Remark title='Note'>
            If MetaMask does not open automatically, please check that the browser extension does
            not have an outstanding request by clicking on its icon.
          </Remark>
        </div>
      </DocumentTitle>
    )
