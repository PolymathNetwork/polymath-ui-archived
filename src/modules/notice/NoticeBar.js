      ...
      <div className={'pui-notice-bar pui-notice-bar-' + kind}>
        <div className='pui-notice-bar-contents'>
          <div className='pui-notice-bar-title'>
            <Icon name={kind + '--glyph'} fill='#ffffff' width='24' height='25' />
            {notice.title}
          </div>
          <div className='pui-notice-bar-text' dangerouslySetInnerHTML={{ __html: notice.content }} />
          <div role='button' className='pui-notice-bar-close' onClick={this.handleClose} tabIndex={0}>
