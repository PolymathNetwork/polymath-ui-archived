...
import { ComposedModal, ModalHeader, ModalBody, ModalFooter, Icon, Button } from 'carbon-components-react'
...
class ConfirmModal extends Component<ModalState & DispatchProps> {
  ...
  render () {
    return (
      <ComposedModal open={this.props.isOpen} className={'pui-confirm-modal ' + this.props.className}>
        <ModalHeader
