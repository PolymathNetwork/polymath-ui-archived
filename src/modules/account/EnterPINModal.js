...
class EnterPINModal extends Component<StateProps & DispatchProps> {
  ...
  render () {
    ...
    return (
      <Modal
        className={'pui-tx-modal pui-pin-modal'
        ...
        modalLabel={isSuccess ? 'PIN is Correct' : (isError ? 'Invalid PIN, Please Try Again' : 'Action Required')}
      >
...
export default connect(mapStateToProps, mapDispatchToProps)(EnterPINModal)
